    ...
    <div className="card">
      ...
      {githubUrl && (
        <a
          ...
          className="absolute top-[12px] right-[12px] z-[3] flex items-center justify-center w-[36px] h-[36px] rounded-full bg-[rgba(255,255,255,0.9)] dark:bg-[rgba(10,10,10,0.75)] border border-[rgba(0,0,0,0.1)] dark:border-[rgba(255,255,255,0.15)] backdrop-blur-[20px] dark:backdrop-blur-[8px] transition-all duration-300 hover:bg-black dark:hover:bg-white hover:border-black dark:hover:border-white group"
        >
