    ...
    <div className="card">
      ...
      <div className="card-content">
        ...
        {githubUrl && (
          ...
          >
            {/* Inline SVG on currentColor rather than an <img>: an <img> can't
                inherit text colour, so it needed a brightness-0/dark:invert
                filter, which only yields black or white — the mark stayed black
                while the label turned pink on hover. currentColor follows the
                link in both themes and on hover. */}
