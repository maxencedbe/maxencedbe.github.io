          ...
          <AnimatePresence mode="popLayout">
            {filteredProjects.map((project, index) => {
              ...
              return (
                ...
                >
                  {index > 0 && <div className="w-full max-w-md h-px bg-black/10 dark:bg-white/10 my-2 md:my-3" aria-hidden="true"></div>}
                  <ProjectCard
                    title={project.title}
              ...
              <div className="flex flex-col gap-0 w-full items-center pb-4 md:pb-8">
                {filteredProjects.slice(3).map((project, index) => (
                  <motion.div
                    ...
                    className="flex flex-col items-center w-full"
                  >
                    <div className="w-full max-w-md h-px bg-black/10 dark:bg-white/10 my-2 md:my-3" aria-hidden="true"></div>
                    <ProjectCard
                      title={project.title}
                      description={project.description}
                      imageUrl={project.imageUrl}
