...
const STROKE = 3.5;
const SNAKE = 500;
// Match the site's pink per mode: the deeper rose on the ivory light palette,
// the same rose lifted in lightness on dark. Read from the `.dark` class rather
// than the CSS var so the canvas never has to parse an oklch() fillStyle
// (spotty support); keep both values in sync with --color-pink-400 in global.css.
const pinkForMode = () =>
    document.documentElement.classList.contains("dark") ? "#f0518f" : "#c2185b";
