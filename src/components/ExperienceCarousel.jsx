    ...
    <div className="max-w-[960px] mx-auto">
      ...
      <button
        className={`absolute left-0 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full flex items-center justify-center
          bg-[rgba(253,252,249,0.9)] dark:bg-[rgba(10,10,10,0.88)] backdrop-blur-[20px] dark:backdrop-blur-[8px] border border-black/10 dark:border-[rgba(255,255,255,0.15)] shadow-[0_3px_6px_rgba(0,0,0,0.08),0_8px_15px_rgba(0,0,0,0.1)] dark:shadow-none
      ...
      <div className={`relative z-10 flex justify-center gap-2 mt-5 ${revealDots ? 'dots-lag' : ''}`}>
